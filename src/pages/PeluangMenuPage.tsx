...
const subTopics = [
  { label: "Konsep Dasar Peluang", path: "/materi/peluang/penjumlahan" },
  { label: "Aturan Peluang", path: "/materi/peluang/pengurangan" },
  { label: "Kejadian Majemuk", path: "/materi/peluang/perkalian" },
  { label: "Frekuensi Harapan", path: "/materi/peluang/pembagian" },
  { label: "Soal Campuran", path: "/materi/peluang/campuran" },
  { label: "Latihan Tambahan", path: "/materi/peluang/kpk-fpb" },
];
