...
const subTopics = [
  { label: "Segitiga — Konsep dan Sifat", path: "/materi/segitiga-dan-segiempat/penjumlahan" },
  { label: "Persegi dan Persegi Panjang", path: "/materi/segitiga-dan-segiempat/pengurangan" },
  { label: "Jajargenjang dan Trapesium", path: "/materi/segitiga-dan-segiempat/perkalian" },
  { label: "Belah Ketupat dan Layang-Layang", path: "/materi/segitiga-dan-segiempat/pembagian" },
  { label: "Soal Campuran Bangun Datar", path: "/materi/segitiga-dan-segiempat/campuran" },
  { label: "Latihan Tambahan", path: "/materi/segitiga-dan-segiempat/kpk-fpb" },
];
