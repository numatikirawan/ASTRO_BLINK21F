      ...
      <div className="relative z-10 max-w-3xl w-full px-4 py-10">
        ...
        <div className="flex gap-2 justify-center mb-6">
          {[
            ...
            { key: "dasar" as const, label: "Game Quiz" },
            { key: "olimpiade" as const, label: "Latihan Mandiri" },
          ].map(tab => (
            <button
              key={tab.key}
        ...
        <div className="mt-8 text-center">
          <button
            onClick={() => { playPopSound(); navigate("/materi/bilangan-bulat"); }}
