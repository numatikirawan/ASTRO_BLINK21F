...
const subTopics = [
  { label: "Penjumlahan Bilangan Rasional", path: "/materi/bilangan-rasional/penjumlahan" },
  { label: "Pengurangan Bilangan Rasional", path: "/materi/bilangan-rasional/pengurangan" },
  { label: "Perkalian Bilangan Rasional", path: "/materi/bilangan-rasional/perkalian" },
  { label: "Pembagian Bilangan Rasional", path: "/materi/bilangan-rasional/pembagian" },
  { label: "Operasi Hitung Campuran", path: "/materi/bilangan-rasional/campuran" },
  { label: "KPK dan FPB", path: "/materi/bilangan-rasional/kpk-fpb" },
];
