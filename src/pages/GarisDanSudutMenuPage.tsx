...
const subTopics = [
  { label: "Konsep Dasar Garis dan Sudut", path: "/materi/garis-dan-sudut/penjumlahan" },
  { label: "Hubungan Antar Sudut", path: "/materi/garis-dan-sudut/pengurangan" },
  { label: "Garis Sejajar dan Transversal", path: "/materi/garis-dan-sudut/perkalian" },
  { label: "Membagi Sudut", path: "/materi/garis-dan-sudut/pembagian" },
  { label: "Soal Campuran", path: "/materi/garis-dan-sudut/campuran" },
  { label: "Latihan Tambahan", path: "/materi/garis-dan-sudut/kpk-fpb" },
];
