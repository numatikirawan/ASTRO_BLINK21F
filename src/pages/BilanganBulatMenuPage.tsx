...
const subTopics = [
  { label: "Penjumlahan Bilangan Bulat", path: "/materi/bilangan-bulat/penjumlahan" },
  { label: "Pengurangan Bilangan Bulat", path: "/materi/bilangan-bulat/pengurangan" },
  { label: "Perkalian Bilangan Bulat", path: "/materi/bilangan-bulat/perkalian" },
  { label: "Pembagian Bilangan Bulat", path: "/materi/bilangan-bulat/pembagian" },
  { label: "Operasi Hitung Campuran Bilangan Bulat", path: "/materi/bilangan-bulat/campuran" },
  { label: "KPK dan FPB", path: "/materi/bilangan-bulat/kpk-fpb" },
];
