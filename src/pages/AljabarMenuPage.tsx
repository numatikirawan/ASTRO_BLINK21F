...
const subTopics = [
  { label: "Penjumlahan Bentuk Aljabar", path: "/materi/aljabar/penjumlahan" },
  { label: "Pengurangan Bentuk Aljabar", path: "/materi/aljabar/pengurangan" },
  { label: "Perkalian Bentuk Aljabar", path: "/materi/aljabar/perkalian" },
  { label: "Pembagian Bentuk Aljabar", path: "/materi/aljabar/pembagian" },
  { label: "Operasi Campuran Aljabar", path: "/materi/aljabar/campuran" },
  { label: "Faktorisasi & KPK/FPB Aljabar", path: "/materi/aljabar/kpk-fpb" },
];
