...
const subTopics = [
  { label: "Konsep Dasar Himpunan", path: "/materi/himpunan/penjumlahan" },
  { label: "Irisan dan Gabungan", path: "/materi/himpunan/pengurangan" },
  { label: "Diagram Venn", path: "/materi/himpunan/perkalian" },
  { label: "Komplemen dan Selisih", path: "/materi/himpunan/pembagian" },
  { label: "Soal Cerita Himpunan", path: "/materi/himpunan/campuran" },
  { label: "Latihan Tambahan", path: "/materi/himpunan/kpk-fpb" },
];
